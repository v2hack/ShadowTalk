/****************************************************************************
** Meta object code from reading C++ file 'st_cache.h'
**
...
#include "../src/core/st_cache.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'st_cache.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 6, 14), // "getFriendCount"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 12), // "setCurrentId"
QT_MOC_LITERAL(4, 35, 2), // "id"
QT_MOC_LITERAL(5, 38, 4), // "type"
QT_MOC_LITERAL(6, 43, 4), // "name"
QT_MOC_LITERAL(7, 48, 13) // "getGroupCount"

    },
    "Cache\0getFriendCount\0\0setCurrentId\0"
    "id\0type\0name\0getGroupCount"
};
...
void Cache::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: { int _r = _t->getFriendCount();
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = _r; }  break;
        case 1: _t->setCurrentId((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< QString(*)>(_a[3]))); break;
        case 2: { int _r = _t->getGroupCount();
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = _r; }  break;
        default: ;
        }
    }
...
const QMetaObject Cache::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Cache.data,
      qt_meta_data_Cache,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Cache::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Cache.stringdata0))
        return static_cast<void*>(const_cast< Cache*>(this));
